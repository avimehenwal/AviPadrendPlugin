...
//Adding the vertices
//meshBuilder.addVertex(new Geometry.Vec3(0,0,0), new Geometry.Vec3(0,0,1), 4, 9, 0, 1, 0, 0);//0
//meshBuilder.addVertex(new Geometry.Vec3(0,1,0), new Geometry.Vec3(0,0,1), 4, 9, 0, 1, 0, 0);//1
//meshBuilder.addVertex(new Geometry.Vec3(1,1,0), new Geometry.Vec3(0,0,1), 4, 9, 0, 1, 0, 0);//2
//meshBuilder.addVertex(new Geometry.Vec3(1,0,0), new Geometry.Vec3(0,0,1), 4, 9, 0, 1, 0, 0);//3
//meshBuilder.addVertex(new Geometry.Vec3(0,0,-1), new Geometry.Vec3(0,0,-1), 9, 7, 6, 1, 0, 0);//4
//meshBuilder.addVertex(new Geometry.Vec3(0,1,-1), new Geometry.Vec3(0,0,-1), 9, 7, 6, 1, 0, 0);//5
//meshBuilder.addVertex(new Geometry.Vec3(1,1,-1), new Geometry.Vec3(0,0,-1), 9, 7, 6, 1, 0, 0);//6
//meshBuilder.addVertex(new Geometry.Vec3(1,0,-1), new Geometry.Vec3(0,0,-1), 9, 7, 6, 1, 0, 0);//7
